...
export default {
  ...
  tabActiveBgColor: '#1C2224',

  // Header
  toolbarBtnColor: '#fff',
  toolbarDefaultBg: '#1C2224',
  toolbarHeight: 56,
  ...
  // Radio Button
  radioBtnSize: 23,
  radioSelectedColorAndroid: '#272B2C',
